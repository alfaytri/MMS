...
🚀 Starting: **CC Dialer (3CX XAPI) Plan Task 6: Inbound Call Banner** — `src/hooks/contact-center/useInboundCallAlerts.ts` + `src/components/contact-center/v2/InboundCallBanner.tsx`
