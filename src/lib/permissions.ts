...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'quotations.edit',   label: 'Edit Quotations',   description: 'Edit existing quotation details' },
    ],
  },
  {
    module: 'Contracts',
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'reports.export', label: 'Export Reports',  description: 'Export report data to CSV or PDF' },
    ],
  },
  {
