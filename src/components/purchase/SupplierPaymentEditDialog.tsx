// src/components/purchase/SupplierPaymentEditDialog.tsx
'use client'
...
import { useEditSupplierPayment } from '@/hooks/useSupplierPayments'
...
export function SupplierPaymentEditDialog({ open, onOpenChange, payment }: Props) {
  const edit = useEditSupplierPayment()
  ...
  return (
    <>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          rows={2}
                          placeholder="Reason for edit, correction context, etc."
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
      ...
      {/* Small confirm step — same shape as the record-payment confirmation flow */}
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent className="sm:max-w-sm">
          ...
          <p className="text-sm text-muted-foreground">
            The bill&apos;s outstanding balance and payment status will be recalculated automatically.
          </p>
          <DialogFooter>
            ...
            <Button
              onClick={form.handleSubmit(commit)}
              disabled={edit.isPending}
            >
