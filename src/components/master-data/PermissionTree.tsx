        ...
        children: [
          ...
          },
          {
            ...
            permissions: [
              ...
              { key: 'purchase.orders.tab.chat.view',      label: 'PO Tab: Discussion', description: 'Show the Discussion (chat) tab inside a purchase order' },
        ...
        children: [
          ...
          },
          {
            ...
            permissions: [
              ...
              { key: 'sales.orders.tab.chat.view',       label: 'SO Tab: Discussion', description: 'Show the Discussion (chat) tab inside a sale order' },
