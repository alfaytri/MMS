...
export function InvoiceDetailSidebar({
  ...
  return (
    <aside className="invoice-sidebar w-72 shrink-0 flex flex-col gap-5 p-5 border-r bg-muted/20 min-h-full lg:min-h-screen lg:sticky lg:top-0 overflow-y-auto">
      {/* Company selector */}
