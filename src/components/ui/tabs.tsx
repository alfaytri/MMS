  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "aria-selected:bg-orange-100 aria-selected:text-orange-700 dark:aria-selected:border-input dark:aria-selected:bg-orange-900/30 dark:aria-selected:text-orange-300",
