...
import { useReturnToolUnit, useTeamToolUnits } from '@/hooks/useToolAssignments'
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-left text-xs text-muted-foreground">
                ...
                <th className="p-2 font-medium hidden md:table-cell">Brand</th>
              ...
              {units.map((u) => {
                ...
                return (
                  <tr key={u.unit_id} className="border-b last:border-0 align-top">
                    ...
                    <td className="p-2 hidden sm:table-cell">{u.status}</td>
