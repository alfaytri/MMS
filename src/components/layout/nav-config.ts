    ...
    groups: [
      {
        items: [
          ...
          { label: 'Teams',         href: '/master-data/teams',     icon: 'Users2',      permission: 'warehouse.access' },
          { label: 'Places',        href: '/master-data/places',    icon: 'MapPin',      permission: 'warehouse.access' },
