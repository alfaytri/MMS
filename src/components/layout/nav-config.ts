    ...
    groups: [
      {
        items: [
          ...
          { label: 'MEP',           href: '/master-data/mep',        icon: 'Wrench',      permission: 'warehouse.projects.manage' },
    ...
    groups: [
      {
        items: [
          ...
          { label: 'Consumption Returns', href: '/consumption/returns', icon: 'RotateCcw', permission: 'consumption.returns.view' },
