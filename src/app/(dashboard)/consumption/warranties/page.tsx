...
function WarrantyRecordDetailDialog({
  ...
  const skuMeta = useSkuItemMeta([record?.sku])
  if (!record) return null
  const meta = record.sku ? skuMeta.get(record.sku) : undefined
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <ItemLabel
          ...
          meta={row.original.sku ? skuMeta.get(row.original.sku) : undefined}
          name={row.original.item_name}
          nameClassName="text-sm font-medium truncate max-w-[220px] block"
        />
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <ItemLabel
          ...
          meta={row.original.sku ? skuMeta.get(row.original.sku) : undefined}
          name={row.original.item_name}
          nameClassName="text-sm font-medium truncate max-w-[200px] block"
        />
      ),
    },
    {
            ...
            <DataTable
              ...
              mobileCardRender={(r: WarrantyRecordRow) => (
                <div className="space-y-1.5">
                  ...
                  <ItemLabel meta={r.sku ? skuMeta.get(r.sku) : undefined} name={r.item_name} nameClassName="text-sm font-medium truncate" />
              ...
              mobileCardRender={(c: WarrantyClaimRow) => {
                ...
                return (
                  <div className="space-y-1.5">
                    ...
                    <ItemLabel meta={c.sku ? skuMeta.get(c.sku) : undefined} name={c.item_name} nameClassName="text-sm font-medium truncate" />
                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
