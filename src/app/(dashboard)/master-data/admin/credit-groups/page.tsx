...
export default function CreditGroupsPage() {
  ...
  function openEdit(g: CreditGroup) { setEditTarget(g); setDialogOpen(true) }
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold">Credit Groups</h2>
        <p className="text-sm text-muted-foreground">Define credit tiers — each customer must be assigned a group before creating a sales order</p>
      </div>
      ...
      <AddCreditGroupDialog open={dialogOpen} onOpenChange={setDialogOpen} group={editTarget} />
