-- rpc_redeem_credit_note (migration 20260806131000) built INSERT into
-- payments with p_source_type as plain text, but payments.source_type is
-- an enum (payment_source_type). Postgres raised 42804 the first time an
-- RPC call actually reached the INSERT — smoke test 2026-08-06.
--
-- Fix: cast p_source_type to public.payment_source_type. Every other
-- line preserved.
