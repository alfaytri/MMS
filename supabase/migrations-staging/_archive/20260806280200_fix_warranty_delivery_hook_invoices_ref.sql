-- Fix: create_warranty_records_for_delivery referenced non-existent
-- public.invoices (renamed to so_invoices on 2026-07-24) and used
-- a non-existent sale_delivery_id column. Invoices link through the
-- SO, not directly to deliveries.
