-- ─── Staging seed — reference + org data (regenerated from live) ─────────────
--
-- Regenerated 2026-08-12 (pg_dump --data-only --column-inserts) from the same
-- live source as the baseline, so it carries CURRENT reference data — role
-- permission sets, country codes, currencies, payment methods, reason lists,
-- storage buckets — NOT the stale 2026-08-05 set (e.g. 10 roles vs 8, 43 country
-- codes vs 33). companies + company_divisions are the live org rows; treat them
-- as a starting template and edit for the target project. Tables are emitted in
...
\restrict LRQxATbEndo7DXLwYJNrgshBPPqd9WQ2dYdaOxaWlQTMnKuTd9cF1bgzDtTOAIu
...
INSERT INTO public.companies (id, name_en, name_ar, cr_number, vat_id, default_currency, default_tax_rate, logo_url, address_en, address_ar, is_active, created_at, updated_at, created_by, stamp_url, footer_motto, currency_id) VALUES ('bd4b770b-da6d-473c-ac04-b746f8883c2b', 'RSH', NULL, NULL, NULL, 'QAR', 0, NULL, NULL, NULL, true, '2026-08-11 17:08:47.402459+00', '2026-08-11 17:08:47.402459+00', NULL, NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
INSERT INTO public.companies (id, name_en, name_ar, cr_number, vat_id, default_currency, default_tax_rate, logo_url, address_en, address_ar, is_active, created_at, updated_at, created_by, stamp_url, footer_motto, currency_id) VALUES ('a8a034b2-16f4-4442-a3b0-63b79b3935e6', 'Alfaytri', NULL, NULL, NULL, 'QAR', 0, 'https://optishfnnctrhffpoywg.supabase.co/storage/v1/object/public/division-assets/company-57bcbc47-798c-4461-b23a-a15f21344a04-AlFaytri_logoTRANSPARENT.png', NULL, NULL, true, '2026-08-11 17:07:18.663835+00', '2026-08-11 17:09:03.061532+00', NULL, NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
...
INSERT INTO public.company_divisions (id, slug, name, short_name, color, css_classes, company_name_en, company_name_ar, address_en, address_ar, logo_url, stamp_url, is_active, sort_order, created_at, updated_at, created_by, footer_motto, default_currency, default_tax_rate, company_id, name_ar, address, currency_id) VALUES ('b0dfc0f4-fe96-4582-a517-276aa901d541', 'Alfaytri-Maintenance', 'Maintenance', 'AFM', '#f97316', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, 0, '2026-08-11 17:07:35.60591+00', '2026-08-11 17:07:35.60591+00', NULL, NULL, 'QAR', 0, 'a8a034b2-16f4-4442-a3b0-63b79b3935e6', NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
INSERT INTO public.company_divisions (id, slug, name, short_name, color, css_classes, company_name_en, company_name_ar, address_en, address_ar, logo_url, stamp_url, is_active, sort_order, created_at, updated_at, created_by, footer_motto, default_currency, default_tax_rate, company_id, name_ar, address, currency_id) VALUES ('8215e9b4-0292-4914-a584-c2b26610378f', 'Alfaytri-Kitchen', 'Kitchen', NULL, '#10b981', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, 0, '2026-08-11 17:07:54.753809+00', '2026-08-11 17:07:54.753809+00', NULL, NULL, 'QAR', 0, 'a8a034b2-16f4-4442-a3b0-63b79b3935e6', NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
INSERT INTO public.company_divisions (id, slug, name, short_name, color, css_classes, company_name_en, company_name_ar, address_en, address_ar, logo_url, stamp_url, is_active, sort_order, created_at, updated_at, created_by, footer_motto, default_currency, default_tax_rate, company_id, name_ar, address, currency_id) VALUES ('1b821883-c99e-4177-8144-1c5c1204b007', 'Alfaytri-Trading', 'Trading', 'AFT', '#eab308', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, 0, '2026-08-11 17:08:15.362266+00', '2026-08-11 17:08:15.362266+00', NULL, NULL, 'QAR', 0, 'a8a034b2-16f4-4442-a3b0-63b79b3935e6', NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
INSERT INTO public.company_divisions (id, slug, name, short_name, color, css_classes, company_name_en, company_name_ar, address_en, address_ar, logo_url, stamp_url, is_active, sort_order, created_at, updated_at, created_by, footer_motto, default_currency, default_tax_rate, company_id, name_ar, address, currency_id) VALUES ('2e0018bf-fcb3-481f-9aae-820cc77c060e', 'Alfaytri-MEP', 'MEP', 'AMEP', '#2563eb', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, 0, '2026-08-11 17:08:38.916695+00', '2026-08-11 17:08:38.916695+00', NULL, NULL, 'QAR', 0, 'a8a034b2-16f4-4442-a3b0-63b79b3935e6', NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
INSERT INTO public.company_divisions (id, slug, name, short_name, color, css_classes, company_name_en, company_name_ar, address_en, address_ar, logo_url, stamp_url, is_active, sort_order, created_at, updated_at, created_by, footer_motto, default_currency, default_tax_rate, company_id, name_ar, address, currency_id) VALUES ('c6070d16-a7e4-4ee8-a8ad-0dae5ce3d583', 'RSH-Pest & Cleaning', 'Pest Control & Cleaning', 'RPC', '#2563eb', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, 0, '2026-08-11 17:12:18.815122+00', '2026-08-11 17:12:18.815122+00', NULL, NULL, 'QAR', 0, 'bd4b770b-da6d-473c-ac04-b746f8883c2b', NULL, NULL, '8303b4de-26a4-40ef-b5da-bd1e2ef06f62');
...
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (35, '+351', 'PT', '🇵🇹', 'Portugal', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (36, '+48', 'PL', '🇵🇱', 'Poland', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (37, '+886', 'TW', '🇹🇼', 'Taiwan', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (38, '+52', 'MX', '🇲🇽', 'Mexico', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (39, '+40', 'RO', '🇷🇴', 'Romania', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (40, '+32', 'BE', '🇧🇪', 'Belgium', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (41, '+84', 'VN', '🇻🇳', 'Vietnam', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (42, '+41', 'CH', '🇨🇭', 'Switzerland', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (43, '+66', 'TH', '🇹🇭', 'Thailand', true, 999);
INSERT INTO public.country_codes (id, code, iso, flag, name, is_active, sort_order) VALUES (44, '+421', 'SK', '🇸🇰', 'Slovakia', true, 999);
...
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('c896d7ab-1e93-4c4d-9f3d-2f7d299a2958', 'Brand Manager', 'bg-purple-500/15 text-purple-700 border-purple-500/30', '{inventory.catalog.view,master_data.access,purchase.warehouses.create,purchase.warehouses.manage,purchase.warehouses.view,warehouse.access,warehouse.adjustment.request,warehouse.adjustments.view,warehouse.check.count,warehouse.check.create,warehouse.checks.view,warehouse.settings.create,warehouse.settings.manage,warehouse.stock.view,warehouse.warehouses.view}', false, '2026-07-13 10:38:44.537697+00', '2026-08-12 17:17:05.525213+00', NULL, NULL, true, false);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('3e136807-607d-4280-a2db-3ec40e9016c2', 'Owner', 'bg-rose-500/15 text-rose-600 border-rose-500/30', '{inventory.catalog.manage,inventory.catalog.view,inventory.pricing.manage,master_data.access,master_data.admin.manage,master_data.admin.view,master_data.audit.view,master_data.companies.manage,master_data.companies.view,master_data.customers.change_credit_group,master_data.customers.change_type,master_data.customers.manage,master_data.customers.view,master_data.divisions.manage,master_data.divisions.view,master_data.roles.manage,master_data.roles.view,master_data.service_customers.manage,master_data.service_customers.view,master_data.services.approve,master_data.services.manage,master_data.services.view,master_data.subscriptions.manage,master_data.subscriptions.view,master_data.suppliers.manage,master_data.suppliers.view,master_data.users.manage,master_data.users.view,master_data.warehouses.manage,master_data.warehouses.view,purchase_sales.access,purchase.approvals.bypass,purchase.approvals.chain.manage,purchase.approvals.view,purchase.bills.manage,purchase.bills.view,purchase.dead_stock.view,purchase.debit_notes.view,purchase.landed_costs.manage,purchase.landed_costs.view,purchase.orders.manage,purchase.orders.view,purchase.receivals.manage,purchase.receivals.view,purchase.returns.manage,purchase.returns.view,purchase.shipments.manage,purchase.shipments.view,purchase.warehouses.manage,purchase.warehouses.view,reports.access,reports.accounting.view,reports.dashboard_finance,reports.inventory.view,reports.manage,reports.view,sales.approvals.manage,sales.approvals.view,sales.credit_notes.manage,sales.credit_notes.view,sales.deliveries.manage,sales.deliveries.view,sales.invoices.manage,sales.invoices.view,sales.orders.manage,sales.orders.view,sales.returns.manage,sales.returns.view,system.admin,system.export,system.import,warehouse.access,warehouse.adjustment.request,warehouse.adjustments.view,warehouse.check.count,warehouse.check.create,warehouse.checks.view,warehouse.movements.view,warehouse.receivals.view,warehouse.responsible_person,warehouse.settings.manage,warehouse.stock_value.view,warehouse.stock.view,warehouse.transfer.approve,warehouse.transfer.create,warehouse.transfer.dispatch,warehouse.transfer.receive,warehouse.transfers.view,warehouse.warehouses.view,consumption.cross_division}', true, '2026-07-13 10:38:44.537697+00', '2026-08-12 17:17:05.799233+00', NULL, NULL, true, true);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('d0adccb6-36e9-4ae2-b460-4a758919c88d', 'Purchase Manager', 'bg-blue-500/15 text-blue-700 border-blue-500/30', '{inventory.catalog.view,master_data.access,master_data.suppliers.create,master_data.suppliers.manage,master_data.suppliers.view,purchase_sales.access,purchase.approvals.bypass,purchase.approvals.chain.create,purchase.approvals.chain.manage,purchase.approvals.view,purchase.bills.create,purchase.bills.manage,purchase.bills.view,purchase.orders.create,purchase.orders.manage,purchase.orders.view,purchase.receivals.create,purchase.receivals.manage,purchase.receivals.view,purchase.returns.create,purchase.returns.manage,purchase.returns.view,purchase.rfq.create,purchase.rfq.manage,purchase.rfq.view,purchase.warehouses.view,warehouse.access,warehouse.check.count,warehouse.checks.view,warehouse.settings.create,warehouse.settings.manage,warehouse.stock_value.view,warehouse.stock.view,warehouse.warehouses.view}', false, '2026-07-13 10:38:44.537697+00', '2026-08-12 17:17:05.525213+00', NULL, NULL, true, false);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('c29aa75f-2e84-49ae-81ff-275d0afbecfc', 'exploit', 'bg-primary/15 text-primary border-primary/30', '{inventory.catalog.manage,inventory.catalog.view,inventory.pricing.manage,system.admin}', true, '2026-08-06 10:38:43.560448+00', '2026-08-12 17:17:05.525213+00', NULL, NULL, false, false);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('4e849df2-d196-41bd-9eed-50c82478a9f4', 'inventory_manager', 'bg-emerald-500/15 text-emerald-700 border-emerald-500/30', '{inventory.catalog.view,master_data.access,purchase.warehouses.view,warehouse.access,warehouse.adjustment.approve,warehouse.adjustment.request,warehouse.adjustments.view,warehouse.check.approve,warehouse.check.count,warehouse.check.create,warehouse.checks.view,warehouse.receivals.view,warehouse.settings.create,warehouse.settings.manage,warehouse.stock.view,warehouse.transfer.approve,warehouse.transfer.create,warehouse.transfers.view}', false, '2026-07-13 10:38:44.537697+00', '2026-08-12 17:17:05.525213+00', NULL, NULL, true, false);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('28b8f941-7676-4e39-88fb-165094f4efef', 'consumption', 'bg-primary/15 text-primary border-primary/30', '{consumption.create.custody,consumption.view,operations.access}', false, '2026-08-10 20:23:58.158537+00', '2026-08-12 17:17:05.525213+00', NULL, NULL, false, false);
INSERT INTO public.custom_roles (id, name, color, permissions, is_system_admin, created_at, updated_at, created_by, deleted_at, is_approval_slot, is_inventory_receiver) VALUES ('ad9c5473-f8b8-4cbd-80ec-37e8745cd632', 'Accountant', 'bg-amber-500/15 text-amber-700 border-amber-500/30', '{inventory.catalog.view,master_data.access,master_data.customers.change_credit_group,master_data.customers.change_type,master_data.customers.create,master_data.customers.manage,master_data.customers.view,master_data.suppliers.create,master_data.suppliers.manage,master_data.suppliers.view,purchase_sales.access,purchase.approvals.bypass,purchase.approvals.chain.create,purchase.approvals.chain.manage,purchase.approvals.view,purchase.bills.create,purchase.bills.manage,purchase.bills.view,purchase.dead_stock.view,purchase.debit_notes.view,purchase.landed_costs.create,purchase.landed_costs.manage,purchase.landed_costs.view,purchase.orders.create,purchase.orders.manage,purchase.orders.view,purchase.payments.create,purchase.payments.manage,purchase.payments.view,purchase.receivals.create,purchase.receivals.manage,purchase.receivals.view,purchase.returns.create,purchase.returns.manage,purchase.returns.view,purchase.rfq.create,purchase.rfq.manage,purchase.rfq.view,purchase.shipments.create,purchase.shipments.manage,purchase.shipments.view,purchase.warehouses.create,purchase.warehouses.manage,purchase.warehouses.view,reports.access,reports.accounting.view,reports.create,reports.dashboard_finance,reports.inventory.view,reports.manage,reports.view,sales.approvals.create,sales.approvals.manage,sales.approvals.view,sales.credit_notes.create,sales.credit_notes.manage,sales.credit_notes.view,sales.deliveries.create,sales.deliveries.manage,sales.deliveries.view,sales.invoices.create,sales.invoices.manage,sales.invoices.view,sales.orders.create,sales.orders.manage,sales.orders.view,sales.returns.create,sales.returns.manage,sales.returns.view,warehouse.access,warehouse.adjustment.request,warehouse.adjustments.view,warehouse.check.count,warehouse.check.create,warehouse.checks.view,warehouse.movements.view,warehouse.receivals.view,warehouse.responsible_person,warehouse.settings.create,warehouse.settings.manage,warehouse.stock_value.view,warehouse.stock.view,warehouse.transfer.approve,warehouse.transfer.create,warehouse.transfer.dispatch,warehouse.transfer.receive,warehouse.transfers.view,warehouse.warehouses.view,consumption.cross_division}', false, '2026-07-13 10:38:44.537697+00', '2026-08-12 17:17:05.799233+00', NULL, NULL, true, false);
...
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('e93cf796-f863-405e-a15e-b4daf7931ac1', 'online payment', 'online_payment', true, 3, '2026-07-20 08:09:48.196757+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('81f20676-d9ee-4fa0-b3f6-31db7d062572', 'Bank Transfer', 'bank_transfer', true, 3, '2026-07-26 08:45:43.375884+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('d3d7a01f-f89a-44f3-ba5e-6f2dd7de3cf5', 'Cheque', 'cheque', true, 4, '2026-07-26 08:45:43.375884+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('3add2a80-e824-4851-a1cf-603d11451af0', 'Online Transfer', 'online_transfer', true, 5, '2026-07-26 08:45:43.375884+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('c883a028-4259-435e-a1a6-103fd752f53e', 'Store Credit', 'store_credit', true, 6, '2026-07-26 08:45:43.375884+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('3f7876d2-159d-47fa-ba8b-7d821aa68783', 'Credit Note', 'credit_note', true, 0, '2026-08-06 12:26:31.01304+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('4e851c98-7500-4b5a-ada9-146d98a0e9ef', 'Debit Note', 'debit_note', true, 0, '2026-08-06 13:02:27.749581+00', false, false);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('784992ca-d110-463d-935b-8fb24ee11b18', 'Cash', 'cash', true, 1, '2026-07-13 10:38:44.537697+00', false, true);
INSERT INTO public.payment_methods (id, name, slug, is_active, sort_order, created_at, requires_payment_link, is_cash_equivalent) VALUES ('74ddde7e-a521-42cb-9ad9-00975f1ea21b', 'POS', 'pos', true, 2, '2026-07-13 10:38:44.537697+00', false, false);
...
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('adjustment-photos', 'adjustment-photos', NULL, '2026-08-11 16:26:08.767438+00', '2026-08-11 16:26:08.767438+00', false, false, 10485760, '{image/jpeg,image/png,image/webp}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('avatars', 'avatars', NULL, '2026-08-11 16:01:48.754374+00', '2026-08-11 16:01:48.754374+00', true, false, 5242880, '{image/jpeg,image/png,image/webp,image/gif}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('bill-attachments', 'bill-attachments', NULL, '2026-08-11 16:26:09.036413+00', '2026-08-11 16:26:09.036413+00', false, false, 5242880, '{image/jpeg,image/png,image/webp,application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('bill-pdfs', 'bill-pdfs', NULL, '2026-08-11 16:01:35.996597+00', '2026-08-11 16:01:35.996597+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('booking-confirmations', 'booking-confirmations', NULL, '2026-08-11 16:01:18.274823+00', '2026-08-11 16:01:18.274823+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('consumption-attachments', 'consumption-attachments', NULL, '2026-08-11 16:26:09.427241+00', '2026-08-11 16:26:09.427241+00', false, false, 10485760, '{image/jpeg,image/png,image/webp,application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('credit-note-pdfs', 'credit-note-pdfs', NULL, '2026-08-11 16:01:24.433337+00', '2026-08-11 16:01:24.433337+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('customer-credit-docs', 'customer-credit-docs', NULL, '2026-08-11 16:01:21.51606+00', '2026-08-11 16:01:21.51606+00', false, false, 10485760, '{image/jpeg,image/png,image/webp,application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('delivery-note-pdfs', 'delivery-note-pdfs', NULL, '2026-08-11 16:01:37.370702+00', '2026-08-11 16:01:37.370702+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('division-assets', 'division-assets', NULL, '2026-08-11 16:26:09.949302+00', '2026-08-11 16:26:09.949302+00', true, false, 5242880, '{image/jpeg,image/png,image/webp,image/svg+xml}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('inventory-item-photos', 'inventory-item-photos', NULL, '2026-08-11 16:26:10.08087+00', '2026-08-11 16:26:10.08087+00', true, false, 10485760, '{image/jpeg,image/png,image/webp}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('invoice-pdfs', 'invoice-pdfs', NULL, '2026-08-11 16:01:24.433337+00', '2026-08-11 16:01:24.433337+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('lc-bills', 'lc-bills', NULL, '2026-08-11 16:26:10.344447+00', '2026-08-11 16:26:10.344447+00', false, false, 10485760, '{image/jpeg,image/png,image/webp,application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('po-pdfs', 'po-pdfs', NULL, '2026-08-11 16:01:34.892196+00', '2026-08-11 16:01:34.892196+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('quotation-pdfs', 'quotation-pdfs', NULL, '2026-08-11 16:01:24.433337+00', '2026-08-11 16:01:24.433337+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('receival-check-pdfs', 'receival-check-pdfs', NULL, '2026-08-11 16:01:35.724198+00', '2026-08-11 16:01:35.724198+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('receival-receipt-pdfs', 'receival-receipt-pdfs', NULL, '2026-08-11 16:01:37.088924+00', '2026-08-11 16:01:37.088924+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
INSERT INTO storage.buckets (id, name, owner, created_at, updated_at, public, avif_autodetection, file_size_limit, allowed_mime_types, owner_id, type) VALUES ('return-pdfs', 'return-pdfs', NULL, '2026-08-11 16:01:37.664737+00', '2026-08-11 16:01:37.664737+00', true, false, 10485760, '{application/pdf}', NULL, 'STANDARD');
...
SELECT pg_catalog.setval('public.country_codes_id_seq', 44, true);
...
\unrestrict LRQxATbEndo7DXLwYJNrgshBPPqd9WQ2dYdaOxaWlQTMnKuTd9cF1bgzDtTOAIu
