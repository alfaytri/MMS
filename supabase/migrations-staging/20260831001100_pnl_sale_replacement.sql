-- Phase 3a Task 4 (P&L): recognise the free replacement's cost with ZERO
-- revenue. sale_replacement joins the COGS/revenue set (so its total_cost is
-- counted) but its revenue is forced to 0 (it's a free like-for-like swap).
