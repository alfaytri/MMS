-- Fix: migrations 010 and 011 re-introduced p_brand_variant_id::TEXT in
-- the inventory_stock_movements INSERT, but reference_id is UUID.
-- Migration 008 had already corrected this; this migration restores the
-- correct form (no ::TEXT cast) while preserving all other logic from 011.
