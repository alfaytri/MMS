-- supabase/migrations/20260426000004_fix_apply_receival_edit_atp_guard_v2.sql
--
-- Follow-up to 20260426000003.
-- Fixes two issues in the ATP guard added in that migration:
--   1. Missing FOR UPDATE on inventory_brand_variants SELECT → TOCTOU race
--   2. stock_level nullable → NULL arithmetic silently bypassed the guard
--   3. Adds v_bv_id to exception message for operator clarity
