...
VALUES (
  ...
  ARRAY[
    -- Nav access gates
    'master_data.access', 'purchase_sales.access', 'warehouse.access',
    'orders.access', 'contracts.access', 'invoices.access',
    'teams.access', 'reports.access',
    -- Master Data
...
-- -----------------------------------------------------------------------------
-- 4. Seed baseline payment methods (cash, pos).
-- -----------------------------------------------------------------------------
