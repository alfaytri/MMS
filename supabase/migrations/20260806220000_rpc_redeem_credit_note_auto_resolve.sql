-- Auto-flip credit_notes.status to 'resolved' when a redemption fully
-- consumes the CN. Cosmetic polish surfaced during 2026-08-06 smoke:
-- CN-00031 stayed 'open' in the list even after total_amount = redeemed.
-- The RPC now flips status when (prior + this amount) reaches total.
--
-- Sale-return CNs that were already resolved (status='resolved') skip
-- this — no change to their status. Rest of the body preserved verbatim
-- from 20260806210000.
