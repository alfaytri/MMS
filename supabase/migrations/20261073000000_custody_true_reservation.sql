...
-- custody requested_qty" term added to BOTH guards (20261071 custody create,
-- 20261072 create_transfer_v2) would double-count pending custody. This
-- migration drops that term from both — allocations now cover pending WH->WH
-- and pending custody uniformly.
--
-- Also restores the custody-destination division guard that 20261041 injected
-- into create_transfer_v2 and that 20261072's static rebuild inadvertently
-- dropped (fail-closed: IS NOT TRUE).
--
