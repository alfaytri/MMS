...
INSERT INTO public.custom_roles (name, color, permissions, is_system_admin, is_approval_slot, is_inventory_receiver)
VALUES ('Warehouse Manager', '#6366f1', ARRAY['master_data.access','warehouse.access','operations.access','purchase_sales.access','warehouse.warehouses.view','warehouse.settings.manage','warehouse.stock.view','warehouse.stock_value.view','warehouse.movements.view','warehouse.receivals.view','purchase.warehouses.view','warehouse.transfers.view','warehouse.transfer.create','warehouse.transfer.dispatch','warehouse.transfer.receive','warehouse.transfer.approve','warehouse.adjustments.view','warehouse.adjustment.request','warehouse.checks.view','warehouse.check.count','warehouse.check.create','warehouse.responsible_person','inventory.catalog.view','master_data.warehouses.view','purchase.receivals.view','purchase.receivals.create','purchase.receivals.manage','sales.deliveries.view','sales.deliveries.create','sales.deliveries.manage','damaged_stock.on_hand.view','damaged_stock.on_hand.edit','damaged_stock.out_for_repair.view','damaged_stock.out_for_repair.edit','consumption.view','notify.warehouse.transfers','notify.warehouse.stock_adj','notify.warehouse.inv_check']::text[], false, true, true)
ON CONFLICT (name) DO UPDATE SET
  permissions = EXCLUDED.permissions,
  is_system_admin = EXCLUDED.is_system_admin,
  is_approval_slot = EXCLUDED.is_approval_slot,
